...
- Los p-valores secundarios se ajustan conjuntamente con Holm (familia de 2). Las 10 comparaciones exploratorias del informe se ajustan con Holm en una familia aparte (`exploratory_holm_pvalues`); siguen siendo exploratorias. Los intervalos marginales de 95% no son intervalos simultáneos.
